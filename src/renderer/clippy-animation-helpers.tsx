...
const ANIMATION_DESCRIPTIONS: Record<string, string> = {
  ...
  GestureLeft: "Gestures toward the right; use when pointing attention rightward.",
  GestureRight: "Gestures toward the left; use when pointing attention leftward.",
  ...
  LookDownLeft: "Looks down and to the right.",
  LookDownRight: "Looks down and to the left.",
  LookLeft: "Looks toward the right.",
  LookRight: "Looks toward the left.",
  LookUp: "Looks upward.",
  LookUpLeft: "Looks up and to the right.",
  LookUpRight: "Looks up and to the left.",
